...
from tissue_classifier.feature_extractors.spectrum import extract_spectrum_features
...
def test_compile_all_features(sample_maf_path, sample_seg_path, ref):
    """Compile all features and verify output shape is exactly 4320."""
    ...
    assert result.shape == (1, 4320), f"Expected (1, 4320), got {result.shape}"
